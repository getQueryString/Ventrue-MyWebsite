...
<h1 class="neg title"><span class="bg">Error - 501</span></h1>
<p>Not implemented. To continue:</p>
<p>* Refresh/Reload the page.<br />
  * Clear browser cache.<br />
  * Clear browser cache.<br />
  * Check your VPN and/or Proxy.</br />
  * Reach out to the owner of the website.</p>
  <nav class="error-nav">
