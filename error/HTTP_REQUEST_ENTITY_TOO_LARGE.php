...
<h1 class="neg title"><span class="bg">Error - 413</span></h1>
<p>Request entity too large. To continue:</p>
<p>* Increase upload file size limit via functions file.<br />
  * Increase upload file size limit via .htaccess file.<br />
  * Manually upload file via FTP.</p>
  <nav class="error-nav">
