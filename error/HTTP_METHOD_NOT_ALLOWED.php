...
<h1 class="neg title"><span class="bg">Error - 405</span></h1>
<p>Method not allowed. To continue:</p>
<p>* Double check the URL.<br />
  * Rollback recent upgrades.<br />
  * Uninstall new extensions, modules or plugins.<br />
  * Double check your database changes.</br />
  * Check the configuration files for your web server.<br />
  * Check the application logs.<br />
  * Debug your application code or scripts.</p>
  <nav class="error-nav">
