...
<h1 class="neg title"><span class="bg">Error - 506</span></h1>
<p>Variant also varies. To continue:</p>
<p>* Enable sideloading on windows..<br />
  * Verify that windows registry has trusted apps enabled.</p>
  <nav class="error-nav">
