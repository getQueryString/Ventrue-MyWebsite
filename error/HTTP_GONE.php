...
<h1 class="neg title"><span class="bg">Error - 410</span></h1>
<p>Gone. To continue:</p>
<p>* Disable your site's plugins.<br />
  * Repair your website's .htaccess file.<br />
  * Re-Install your WordPress core files.</p>
  <nav class="error-nav">
